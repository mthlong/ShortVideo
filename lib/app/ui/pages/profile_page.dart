      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Text("Chào mừng các bạn đến với app và đây là bio 🤣😊☺️", maxLines: 3,style: AppTextStyle.appTextStyle(
                context, 12, AppColors.grey, FontWeight.normal), overflow: TextOverflow.ellipsis, textAlign: TextAlign.center,),
          ),
        ],
      ),
    );
